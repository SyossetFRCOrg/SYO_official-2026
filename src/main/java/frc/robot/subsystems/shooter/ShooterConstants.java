...
public class ShooterConstants {
    ...
    public static final int centerMotorID = 2;
    public static final int rightMotorID = 3;

    public static final double left_kP = 100;
    public static final double left_kD = 0;
    public static final double left_kS = 0;
    public static final double left_kV = 12.0 / 5600.0;
    public static final double left_kA = 0;

    public static final double center_kP = 100;
    public static final double center_kD = 0;
    public static final double center_kS = 0;
    public static final double center_kV = 12.0 / 5600.0;
    public static final double center_kA = 0;

    public static final double right_kP = 100;
    public static final double right_kD = 0;
    public static final double right_kS = 0;
    public static final double right_kV = 12.0 / 5600.0;
